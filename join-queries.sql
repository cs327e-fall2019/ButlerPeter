...
from nfl_stats_staging.Basic_Stats as b
join nfl_stats_staging.Passing_Career_Stats as p on b.player_id = p.player_id
...
from nfl_stats_staging.Basic_Stats as b
join nfl_stats_staging.Rushing_Career_Stats as r on b.player_id = r.player_id
...
from nfl_stats_staging.Basic_Stats as b
full join nfl_stats_staging.Passing_Career_Stats as c on b.player_id = c.player_id
where b.age >= 35
order by age desc
...
from nfl_stats_staging.Basic_Stats as b
full join nfl_stats_staging.Rushing_Career_Stats as c on b.player_id = c.player_id
...
from nfl_stats_staging.Basic_Stats as b
full join nfl_stats_staging.Receiving_Career_Stats as c on b.player_id = c.player_id
where b.position = "QB"
