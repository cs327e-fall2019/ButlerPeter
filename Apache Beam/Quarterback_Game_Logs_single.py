...
with beam.Pipeline('DirectRunner', options=opts) as p:
    ...
    query_results = p | 'Read from BigQuery' >> beam.io.Read(beam.io.BigQuerySource(query='SELECT * FROM nfl_stats_modeled.Quarterback_Game_Logs LIMIT 100'))
    ...
    qualified_table_name = PROJECT_ID + ':nfl_stats_modeled.Quarterback_Game_Logs_Beam'
