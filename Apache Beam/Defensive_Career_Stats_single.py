...
with beam.Pipeline('DirectRunner', options=opts) as p:
    ...
    query_results = p | 'Read from BigQuery' >> beam.io.Read(beam.io.BigQuerySource(query='SELECT * FROM nfl_stats_modeled.Defensive_Career_Stats LIMIT 100'))
    ...
    # write PCollection to log file
    formatedInt_pcoll | 'Write to log 2' >> WriteToText('input2.txt')
    ...
    qualified_table_name = PROJECT_ID + ':nfl_stats_modeled.Defensive_Career_Stats_Beam'
