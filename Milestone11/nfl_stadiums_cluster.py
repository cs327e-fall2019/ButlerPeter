...
with beam.Pipeline('DataFlowRunner', options=opts) as p:
    ...
    query_results = p | 'Read from BigQuery' >> beam.io.Read(beam.io.BigQuerySource(query='SELECT * FROM   nfl_weather_workflow_modeled.nfl_stadiums'))
